...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"app/controllers/CalenderController.ts":[function(require,module,exports) {
"use strict";
...
var CalenderController = /*#__PURE__*/function () {
  function CalenderController(calenderModel, calenderUIModel) {
    _classCallCheck(this, CalenderController);

    this.calender = calenderModel;
    this.calenderUI = calenderUIModel;
  }

  _createClass(CalenderController, [{
    key: "render",
    value: function render() {
      var _this = this;

      var currentMonth = this.calender.getMonth();
      var todaysDate = this.calender.getCurrentDate();
      this.calenderUI.createCalender(todaysDate);
      this.calenderUI.insertCurrentMonthInMonthHolder(currentMonth);
      setInterval(function () {
        return _this.calenderUI.displayHour(_this.calender.getCurrentTimeString());
      }, 1000);
    }
  }, {
    key: "moveToNextWeek",
    value: function moveToNextWeek() {
      var _this2 = this;

      console.log('moveToNextWeek', this.calenderUI.buttonRight);
      this.calenderUI.buttonRight.addEventListener('click', function () {
        return _this2.calender.next();
      });
    }
  }, {
    key: "previous",
...
exports.default = CalenderController; // import {
...
},{}],"app/controllers.ts":[function(require,module,exports) {
"use strict";
...
var CalenderController_1 = __importDefault(require("./controllers/CalenderController"));

exports.CalenderController = CalenderController_1.default;
},{"./controllers/CalenderController":"app/controllers/CalenderController.ts"}],"../node_modules/date-fns/esm/_lib/toInteger/index.js":[function(require,module,exports) {
"use strict";
...
var convertToTwoDigits = function convertToTwoDigits(number) {
  return (number < 10 ? '0' : '') + number.toString();
};

exports.default = convertToTwoDigits;
},{}],"app/helpers.ts":[function(require,module,exports) {
"use strict";
...
exports.convertToTwoDigits = void 0;

var convertToTwoDigits_1 = __importDefault(require("./helpers/convertToTwoDigits"));

exports.convertToTwoDigits = convertToTwoDigits_1.default;
},{"./helpers/convertToTwoDigits":"app/helpers/convertToTwoDigits.ts"}],"app/models/CalenderModel.ts":[function(require,module,exports) {
"use strict";
...
var CalenderModel = /*#__PURE__*/function () {
  function CalenderModel() {
    _classCallCheck(this, CalenderModel);

    this.currentDate = new Date();
    this.months = ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'Augst', 'September', 'October', 'November', 'December']; // getDay starts with 0 = Sunday

    this.days = ['Sunday', 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday'];
  }

  _createClass(CalenderModel, [{
    key: "getMonth",
    value: function getMonth() {
      var monthIndex = date_fns_1.getMonth(this.currentDate);
    ...
    value: function getCurrentTimeString() {
      ...
      return "".concat(helpers_1.convertToTwoDigits(hour), ":").concat(helpers_1.convertToTwoDigits(mins), ":").concat(helpers_1.convertToTwoDigits(secs));
    }
  }, {
    key: "addDaysToCurrentDate",
    value: function addDaysToCurrentDate() {
      var daysToAdd = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;
      return date_fns_1.addDays(this.currentDate, daysToAdd);
    }
  }, {
    key: "next",
    value: function next() {
      console.log('works');
      var newDate = date_fns_1.addDays(this.currentDate, 7);
...
},{"date-fns":"../node_modules/date-fns/esm/index.js","../helpers":"app/helpers.ts"}],"app/models/CalenderUIModel.ts":[function(require,module,exports) {
"use strict";
...
var CalenderUIModel = /*#__PURE__*/function () {
  function CalenderUIModel() {
    _classCallCheck(this, CalenderUIModel);

    this.buttonLeft = document.querySelector('.calender__button--left');
    this.buttonRight = document.querySelector('.calender__button--right');
  }

  _createClass(CalenderUIModel, [{
    key: "buildCalendar",
    ...
    key: "addDaysContainer",
    value: function addDaysContainer() {
    ...
    key: "createDays",
    value: function createDays(todaysDate) {
      for (var i = -3; i <= 3; i++) {
        this.day = document.createElement('div');
        var dateDisplay = document.createElement('span');
        var dateToInsert = date_fns_1.addDays(todaysDate, i);
        var isBeforeIndex = date_fns_1.compareAsc(todaysDate, dateToInsert);
        ...
        dateDisplay.innerHTML = date_fns_1.format(dateToInsert, 'dd/MM/yyyy');
    ...
    key: "createCalender",
    value: function createCalender(today) {
      this.buildCalendar().addHeader().addDaysContainer().createDays(today); // this.addDetailsToDayContainer();
    }
  }, {
    key: "insertCurrentMonthInMonthHolder",
    value: function insertCurrentMonthInMonthHolder(time) {
      this.dateHolder.innerHTML = time;
    }
  }, {
    key: "displayHour",
    value: function displayHour(hour) {
...
exports.default = CalenderUIModel;
},{"date-fns":"../node_modules/date-fns/esm/index.js"}],"app/models.ts":[function(require,module,exports) {
"use strict";
...
exports.CalenderUIModel = exports.CalenderModel = void 0;

var CalenderModel_1 = __importDefault(require("./models/CalenderModel"));

exports.CalenderModel = CalenderModel_1.default;

var CalenderUIModel_1 = __importDefault(require("./models/CalenderUIModel"));

exports.CalenderUIModel = CalenderUIModel_1.default;
},{"./models/CalenderModel":"app/models/CalenderModel.ts","./models/CalenderUIModel":"app/models/CalenderUIModel.ts"}],"app/main.ts":[function(require,module,exports) {
"use strict";
...
var initializeCalender = function initializeCalender() {
  var calender = new models_1.CalenderModel();
  var calenderUI = new models_1.CalenderUIModel();
  var calenderController = new controllers_1.CalenderController(calender, calenderUI);
  calenderController.render();
  calenderController.moveToNextWeek();
};

initializeCalender(); //todo - kalendarz ma być tworzony dynamiczniei jak w Ract'cie
...
//   }
// }
},{"./controllers":"app/controllers.ts","./models":"app/models.ts"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","app/main.ts"], null)
